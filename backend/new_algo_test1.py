...
class TestNewAlgo(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        u1 = create_update_user(json.dumps(user1))
        u2 = create_update_user(json.dumps(user2))
        u3 = create_update_user(json.dumps(user3))
        u4 = create_update_user(json.dumps(user4))
        u5 = create_update_user(json.dumps(user5))
        u6 = create_update_user(json.dumps(user6))
        ...
        u1.update(
            settings=create_update_settings(json.dumps(settings1)),
            profile=create_update_profile(json.dumps(profile1))
        )
        # u1.settings = create_update_settings(json.dumps(settings1))
        # u1.profile = create_update_profile(json.dumps(profile1))

        u2.update(
            settings=create_update_settings(json.dumps(settings2)),
            profile=create_update_profile(json.dumps(profile2))
        )
        ...
        u3.update(
            settings=create_update_settings(json.dumps(settings3)),
            profile=create_update_profile(json.dumps(profile3))
        )
        ...
        u4.update(
            settings=create_update_settings(json.dumps(settings4)),
            profile=create_update_profile(json.dumps(profile4))
        )
        ...
        u5.update(
            settings=create_update_settings(json.dumps(settings5)),
            profile=create_update_profile(json.dumps(profile5))
        )
        ...
        u6.update(
            settings=create_update_settings(json.dumps(settings6)),
            profile=create_update_profile(json.dumps(profile6))
        )
    ...
    def test_algo_1(self):
        ...
        expected_profile = get_user_profile_by_email("chris@gmail.com")
    ...
    def test_algo_2(self):
        ...
        candidates = get_matches(data)
        expected_profile = get_user_profile_by_email("patrick@gmail.com")
        # print("Expected: ", expected_profile)
        self.assertEqual(candidates[0], expected_profile)
    ...
    def test_algo_3(self):
        ...
        candidates = get_matches(data)
        expected_profile = get_user_profile_by_email("alice@gmail.com")
        # print("Expected: ", expected_profile)
        self.assertEqual(candidates[0], expected_profile)
    ...
    def test_algo_4(self):
        ...
        candidates = get_matches(data)
        expected_profile = get_user_profile_by_email("robert@gmail.com")
        # print("Expected: ", expected_profile)
        self.assertEqual(candidates[0], expected_profile)
