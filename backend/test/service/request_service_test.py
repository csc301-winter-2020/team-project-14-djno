...
#    def setUp(self) -> None:
        ...
        ru2.delete()
        ru3 = RequestService.Request.objects(
            requestor_email='nathan@gmail.com')
        ru3.delete()
        ru5 = RequestService.Request.objects(
            requestor_email='elaine@gmail.com')
        ru5.delete()
        ...
        u3 = UserService.create_user(
            "nathan@gmail.com", [51.561482, -87.906550])
        u4 = UserService.create_user(
            "chris@gmail.com", [43.653225, -79.383186])
        u5 = UserService.create_user(
            "elaine@gmail.com", [43.653742, -79.383906])
