...
class TestUserService(unittest.TestCase):
    ...
    def test_create_user_with_email_repeating_email(self):
        ...
        self.assertFalse(UserService.create_user(
            u2_email, [55.653225, -69.383186]))

    def test_create_user_with_email_invalid_email(self):
        u3_email = "peter@fakeemail"

        self.assertFalse(UserService.create_user(
            u3_email), [20.653225, -20.383186])
    ...
    def test_create_profile_email_does_not_exist(self):
        ...
        user_profile = UserService.create_profile(
            u7_email, 'ab', 'c', '2019-09-24', 24, 'Male', "Toronto", "url_1")
    ...
    def test_create_profile_repeating_email(self):
        ...
        p8 = UserService.create_profile(
            u8_email, u8_first_name, u8_last_name, u8_date_of_birth, u8_age, u8_gender, u8_location, u8_url)
        ...
        p9 = UserService.create_profile(
            u9_email, u9_first_name, u9_last_name, u9_date_of_birth, u9_age, u9_gender, u9_location, u9_url)
    ...
    def test_update_profile(self):
        ...
        tp12a = UserService.update_profile(
    ...
    def test_create_settings(self):
        ...
        s14 = UserService.create_settings(
            email, gps, preferences, days, time_of_day)
    ...
    def test_update_settings(self):
        ...
        ts17 = UserService.update_settings(
            email, gps, preferences, days, time_of_day)
