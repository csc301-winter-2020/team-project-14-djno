...
class TestUserService(unittest.TestCase):
    ...
    def test_create_profile(self):
        ...
        user_profile = UserService.create_profile(u1_email, u1_first_name, u1_last_name, u1_date_of_birth, u1_gender, u1_url, u1_desc)
    ...
    def test_create_profile_repeating_email(self):
        ...
        user1_profile = UserService.create_profile(u1_email, u1_first_name, u1_last_name, u1_date_of_birth, u1_gender, u1_url, u1_desc)
        ...
        user2_profile = UserService.create_profile(u2_email, u2_first_name, u2_last_name, u2_date_of_birth, u2_gender, u2_url, u2_desc)
