...
class TestUserService(unittest.TestCase):
    ...
    def test_create_profile(self):
        ...
        user_profile = UserService.create_profile(u1_email, u1_first_name, u1_last_name, u1_date_of_birth, u1_gender)
    ...
    def test_create_profile_repeating_email(self):
        ...
        user1 = UserService.create_user_with_gmail(u1_email)
        user1_profile = UserService.create_profile(u1_email, u1_first_name, u1_last_name, u1_date_of_birth, u1_gender)
