...
class TestUserService(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        du0 = User.objects(email="aaaaaabbbbb@gmail.com")
        du0.delete()

        du1 = User.objects(email="scarlett@gmail.com")
        du1.delete()

        du4 = User.objects(email="tripleh@gmail.com")
        du4.delete()

        du6 = User.objects(email="michaeljackson@gmail.com")
        du6.delete()

        du7 = User.objects(email="newperson@gmail.com")
        du7.delete()

        du8 = User.objects(email="peterjackson@gmail.com")
        du8.delete()

        du10 = User.objects(email="wyatt@gmail.com")
        du10.delete()

        pu6 = Profile.objects(email="michaeljackson@gmail.com")
        pu6.delete()

        pu7 = Profile.objects(email="newperson@gmail.com")
        pu7.delete()

        pu8 = Profile.objects(email="peterjackson@gmail.com")
        pu8.delete()

        pu12 = Profile.objects(email="baxter@gmail.com")
        pu12.delete()

        su13 = Settings.objects(email="fernandez@gmail.com")
        su13.delete()

        su14 = Settings.objects(email="jacqueline@gmail.com")
        su14.delete()
    ...
    def test_create_profile_repeating_email(self):
        ...
        p8 = create_profile(u8_email, u8_first_name, u8_last_name, u8_date_of_birth, u8_age, u8_gender, u8_location, u8_url)
        ...
        p9 = create_profile(u9_email, u9_first_name, u9_last_name, u9_date_of_birth, u9_age, u9_gender, u9_location, u9_url)
    ...
    def test_create_update_user(self):
        ...
        u10 = create_update_user(json.dumps(user10))

        self.assertEqual(u10.email, "wyatt@gmail.com")

    def test_get_user_by_email(self):

        u10a = get_user_by_email("wyatt@gmail.com")
        u11 = get_user_by_email("corvin@gmail.com")
    ...
    def test_email_available(self):
        ...
        e1 = email_available("courage@gmail.com")
        e2 = email_available("wyatt@gmail.com")
    ...
    def test_create_update_profile(self):
        ...
        p12 = create_update_profile(json.dumps(prof12))

        self.assertEqual(p12.email, "baxter@gmail.com")


    def test_get_user_profile_by_email(self):
        tp12 = get_user_profile_by_email("baxter@gmail.com")
    ...
    def test_update_profile(self):
        ...
        tp12a = update_profile(email, first_name, last_name, date_of_birth, age, gender, location, image_url)
    ...
    def test_create_update_settings(self):
        ...
        s13 = create_update_settings(json.dumps(sett13))
    ...
    def test_create_settings(self):
        ...
        s14 = create_settings(email, gps, preferences, days, time_of_day)

        self.assertEqual(s14.email, "jacqueline@gmail.com")

    def test_get_user_settings_by_email(self):
        ts15 = get_user_settings_by_email("jacqueline@gmail.com")
        ts16 = get_user_settings_by_email("horatio@gmail.com")
    ...
    def test_update_settings(self):
        ...
        ts17 = update_settings(email, gps, preferences, days, time_of_day)
